...
export const getStaticProps: GetStaticProps<INewsDetail> = async (context) => {
  ...
  const data = await getNewsByUUIDAndCategory(newsId as string, 'health');
  const relatedNews = await getRelatedNewsByUUIDAndCategory(newsId as string, 'health');
  // const mostViewed = await getHighlightNewsByCategory('health');
    ...
    <>
      <div className="grid grid-cols-3 gap-4">
        <div className="col-span-2">
          <h3 className="py-4 text-xl font-bold">Health News</h3>
