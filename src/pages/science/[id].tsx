...
export const getStaticProps: GetStaticProps<INewsDetail> = async (context) => {
  ...
  const data = await getNewsByUUIDAndCategory(newsId as string, 'science');
  const relatedNews = await getRelatedNewsByUUIDAndCategory(newsId as string, 'science');
  // const mostViewed = await getHighlightNewsByCategory('science');
    ...
    <>
      <div className="grid grid-cols-3 gap-4">
        <div className="col-span-2">
          <h3 className="py-4 text-xl font-bold">Science News</h3>
